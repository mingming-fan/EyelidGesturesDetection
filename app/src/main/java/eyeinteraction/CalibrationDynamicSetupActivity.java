...
public class CalibrationDynamicSetupActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    String[] numOfTrialsCode = {"5", "1", "3", "10", "15", "20"};

    Spinner spinParticipant, spinGlasses, spinTrials;

    // Update: now we don't show these checkbox here.
    // Instead, there won'e be any visualization boxes in this class, and we set these attributes as False,
    // and in the PerformanceMeasureSetupActivity, we set these attributes as True.
