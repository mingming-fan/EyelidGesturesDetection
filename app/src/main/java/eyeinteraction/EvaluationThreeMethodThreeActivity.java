 ...
 */
public final class EvaluationThreeMethodThreeActivity extends AppCompatActivity implements View.OnClickListener, View.OnSystemUiVisibilityChangeListener {
    private final String TAG = EvaluationThreeMethodThreeActivity.this.getClass().getSimpleName();
...
//    String glassCode;
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_evaluation_three_method_three);
...
//        glassCode = b.getString("glassCode");
        ...
        //String filename = participantCode + "_" + glassCode + "_3_PIiBlink_" + System.currentTimeMillis() + ".csv";
        ...
        mEtTranscribed.setEnabled(false);
...
//                    condition);
            sd2Leader = String.format("%s,%s", participantCode, condition);
        ...
        public void onUpdate(FaceDetector.Detections<Face> detectionResults, Face face) {
            ...
            if(mGesture.length() > 0){
                ...
                if(state.equals("Close")){
                    mEtTranscribed.post(new Runnable() {
                        @Override
                        public void run() {
                            layer3.setAlpha(0.8f);

                            layer1.setAlpha(1.0f);
                            mEtTranscribed.setEnabled(true);
                            mBtConfirm.setEnabled(true);
                            mEtTranscribed.bringToFront();
                            mBtConfirm.bringToFront();
                            layer3.bringToFront();
                            layer1.invalidate();
                            layer3.invalidate();
                        }
