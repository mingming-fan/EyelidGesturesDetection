 ...
 */
public final class PerformanceMeasureActivity extends AppCompatActivity implements View.OnClickListener{
    private final boolean chineseStr = false;

    // in this mode, we don't need counter.
    private boolean initCounter = true;
    private final String TAG = PerformanceMeasureActivity.this.getClass().getSimpleName();
