...
public class PerformanceMeasureSetupActivity extends AppCompatActivity implements View.OnClickListener{
    private final String TAG = PerformanceMeasureSetupActivity.this.getClass().getSimpleName();
...
//    CheckBox chb_graph;
    boolean usePreTrainedModel = true;  //whether to load a pretrained model or not
    boolean showGraph = true;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_performance_measure_setup);
...
//                String trial = numOfTrialsCode[spinTrials.getSelectedItemPosition()];
                // this value doesn't matter since we are entering the performance measure session
                String trial = "5";
                ...
                Intent i = new Intent(getApplicationContext(), PerformanceMeasureActivity.class);
                i.putExtras(b);
                startActivity(i);
                finish();
                break;
